<div class="bg-gray-50 dark:bg-gray-800 sm:rounded-lg w-full h-full">
    <div class="flex justify-between px-2 py-2">
        ...
        <div class="justify-end">
            <button data-modal-target="reg-almacenes" data-modal-toggle="reg-almacenes" type="button"
    ...
    <!-- Main modal -->
    <div wire:ignore.self id="reg-almacenes" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="reg-departamento">
                ...
                <div class="p-4 md:p-5">
                    ...
                    <form class="space-y-4" wire:submit.prevent="save" novalidate>
                        ...
                        <div>
                            <label for="lugar"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lugar</label>
                            <input type="lugar" name="lugar" id="lugar" wire:model='lugar'
