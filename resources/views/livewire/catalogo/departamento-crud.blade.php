<div class="bg-gray-50 dark:bg-gray-800 sm:rounded-lg w-full h-full">
    <div class="flex justify-between px-2 py-2">
        ...
        <div class="justify-end">
            <button data-modal-target="reg-departamento" data-modal-toggle="reg-departamento" type="button"
    ...
    <!-- Main modal -->
    <div wire:ignore.self id="reg-departamento" tabindex="-1" aria-hidden="true"
                ...
                <div class="p-4 md:p-5">
                    ...
                    <form class="space-y-4" wire:submit.prevent="save" novalidate>
                        ...
                        <div>
                            ...
                            <input type="departamento" name="departamento" id="departamento" wire:model='departamento'
