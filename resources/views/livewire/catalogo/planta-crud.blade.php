<div class="bg-gray-50 dark:bg-gray-800 sm:rounded-lg w-full h-full">
    <div class="flex justify-between px-2 py-2">
        ...
        <div class="justify-end">
            <button data-modal-target="reg-planta" data-modal-toggle="reg-planta" type="button"
    ...
    <div class="relative overflow-x-auto shadow-lg sm:rounded-lg h-44 overflow-y-auto">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-800 dark:text-gray-400">
                <tr>
                    <th scope="col" class="px-6 py-3 rounded-tl-lg bg-gray-50 dark:bg-gray-800">
                        Codigo
                    </th>
                    <th scope="col" class="px-6 py-3 rounded-tr-lg bg-gray-100 dark:bg-gray-700">
                        Planta
                    </th>
                </tr>
            </thead>
    ...
    <!-- Main modal -->
    <div wire:ignore.self id="reg-planta" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    ...
                    <form class="space-y-4" wire:submit.prevent="save" novalidate>
                        ...
                        <div>
                            <label for="nombre"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Planta</label>
                            <input type="nombre" name="nombre" id="nombre" wire:model='nombre'
