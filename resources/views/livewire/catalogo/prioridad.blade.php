<div class="bg-gray-50 dark:bg-gray-800 sm:rounded-lg w-full h-full">
    ...
    <div class="flex justify-between px-2 py-2">
        ...
        <h1>Prioridades de la OT</h1>

        <div class="justify-end">
            <button data-modal-target="reg-prioridades" data-modal-toggle="reg-prioridades" type="button"
    ...
    <!-- Main modal -->
    <div wire:ignore.self id="reg-prioridades" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="reg-prioridades">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" wire:submit.prevent='save' novalidate>
                        <div>
                            ...
                            <input type="prioridad" name="prioridad" id="prioridad" wire:model='prioridad' placeholder="Tipo de prioridad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                required>
                        ...
                        <div>
                            ...
                            name="descripcion" id="descripcion"
                                placeholder="Descripcion de prioridad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                required>
