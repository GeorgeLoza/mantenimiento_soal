<div class="bg-gray-50 dark:bg-gray-800 sm:rounded-lg  w-full h-full">
    ...
    <div class="flex justify-between px-2 py-2">
        ...
        <h1>Tipo de Maquinas</h1>

        <div class="justify-end">
            <button data-modal-target="reg-tipomaq" data-modal-toggle="reg-tipomaq" type="button"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg h-44 overflow-y-auto">
        ...
        <!-- Main modal -->
        <div wire:ignore.self id="reg-tipomaq" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            Registro de Tipos de Maquina
                        </h3>
                        <button type="button"
                            class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-hide="reg-tipomaq">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" wire:submit.prevent="save" novalidate>
                            ...
                            <div>
                                <label for="nombre"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Maquina</label>
