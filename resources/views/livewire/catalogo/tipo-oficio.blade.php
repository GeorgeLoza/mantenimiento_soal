<div class="bg-gray-50 dark:bg-gray-800 sm:rounded-lg  w-full h-full">
    ...
    <div class="flex justify-between px-2 py-2">
        ...
        <div class="justify-end">
            <button data-modal-target="reg-oficio" data-modal-toggle="reg-oficio" type="button"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg h-44 overflow-y-auto">
        ...
        <!-- Main modal -->
        <div wire:ignore.self id="reg-oficio" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" wire:submit.prevent="save" novalidate>
                            ...
                            <div>
                                <label for="oficio"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Oficio</label>
                                <input type="oficio" name="oficio" wire:model='oficio' id="oficio"
