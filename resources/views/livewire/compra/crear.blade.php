    ...
    <div class="p-2">
        <form wire:submit="save" novalidate>
            ...
            <div class="md:flex gap-2">
                <div class="md:w-1/2">
                    <label for="factura"
                        class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Factura</label>
                    <input type="text" id="factura" wire:model="factura"
                ...
                <div class="md:w-1/2">
                    ...
                    <select id="proveedor" wire:model="proveedor_id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="md:flex gap-2 mt-2">
                <div class="md:w-1/2">
                    <label for="almacen"
                        class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Buscar Repuesto</label>
                    <div class="relative">
                ...
                <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                    ...
                    <tbody class="">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <th class="p-1">
                                <input type="number" step="0.01" wire:model.live='precio' placeholder=""
                                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </th>
                            <th class="px-4 py-2">
                        ...
                        @foreach ($posibles as $posible)
                            <tr
                                ...
                                <th scope="row"
                                    ...
                                    {{Str::limit( $posible->repuestos->nombre,15) }}
                                </th>
