                    ...
                    <tr
                        ...
                        <td class="px-4 py-2">
                            <div class="flex items-center justify-center gap-2">
                                <svg onclick="Livewire.dispatch('openModal', { component: 'ordenes-trabajo.solicitud.editar', arguments: { id:  } })"
                                ...
                                <svg onclick="Livewire.dispatch('openModal', { component: 'ordenes-trabajo.solicitud.eliminar', arguments: { id: } })"
