            ...
            <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                ...
                <tbody class="">
                    ...
                    <tr
                        ...
                        <td class="px-4 py-2">
                            <b class="text-sky-400">{{ $repuesto->ubicacionActual }}</b>
                        </td>
                        <td class="px-4 py-2">
                            <b class="text-sky-400">{{ $repuesto->precioRelativo }} Bs </b>
                        </td>
                        <td>{{ $repuesto->almacen_id == 1 ? $repuesto->stock_actual : '-' }} {{$repuesto->unidad}}</td>
                        <td>{{ $repuesto->almacen_id == 2 ? $repuesto->stock_actual : '-' }} {{$repuesto->unidad}}</td>

                        <td class="px-4 py-2">
                            <div class="flex items-center justify-center gap-2">
                                <svg onclick="Livewire.dispatch('openModal', { component: 'repuesto.editar', arguments: { id: {{ $repuesto->id }} } })"
                                ...
                                <svg onclick="Livewire.dispatch('openModal', { component: 'repuesto.eliminar', arguments: { id: {{ $repuesto->id }} } })"
